...
public class Menu {
	...
	public void display() {
			...
			while(displayMenu) {
				...
				System.out.println("viewall -> show all employee details");
				...
				case "changerole" : {
					...
					for(Employee e: employees) {
						...
						System.out.println(
								"Employee ID: " + e.getEmployee_id() + ", " +
								"Name: " + e.getF_name() + " " + e.getL_name() + ", " + 
								"Role ID: " + e.getRole_id() 
								);
					}
				...
				case "viewall" : {
					System.out.println("Gathering all employees details....");
					...
					for(Employee e: employees) {
						...
						System.out.println(
								"Employee ID: " + e.getEmployee_id() + ", " +
								"First Name: " + e.getF_name() + ", " +
								"Middle Name: " + e.getM_name() + ", " +
								"Last Name: " + e.getL_name() + ", " +
								"DOB: " + e.getDob() + ", " +
								"Phone #: " + e.getPhone() + ", " +
								"Street Address: " + e.getStreet_address() + ", " +
								"City: " + e.getCity() + ", " +
								"Zip Code: " + e.getZip_code() + ", " +
								"Gender: " + e.getGender() + ", " +
								"Marital Status: " + e.getMarital_status() + ", " +
				...
				case "exit" : {
					System.out.println("You have exited the Diablo Foods Employee Management System!");
					displayMenu = false;
					break;
				}
